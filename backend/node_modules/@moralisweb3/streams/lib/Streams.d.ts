...
export declare class Streams implements ApiModule {
    private readonly core;
    static create(core?: Core): Streams;
    readonly name = "streams";
    readonly type = ModuleType.API;
    readonly baseUrl = "https://api.moralis-streams.com";
    private constructor();
    setup(): void;
    start(): void;
    ...
    readonly getById: ({ network, ...options }: import("./methods/getById").GetStreamEvmOptions) => Promise<import("@moralisweb3/common-core").ResponseAdapter<import("@moralisweb3/common-streams-utils").EvmStream, {
        webhookUrl: string;
        description: string;
        tag: string;
        topic0?: string[] | null | undefined;
